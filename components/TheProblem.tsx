...
const problems = [
  {
    icon: '👁️',
    title: 'Every business looks the same.',
    desc: 'Same logo templates. Same stock photos. Same color palettes from the same design trends. Standing out visually is harder than ever.',
  },
  {
    icon: '🗣️',
    title: 'Every business sounds the same.',
    desc: 'Generic stock music. No brand voice. No audio identity. Customers hear nothing that makes your brand feel different, real, or remembered.',
  },
  {
    icon: '🎯',
    title: 'Customers forget fast.',
    desc: 'Without emotional memory — triggered by sound — your brand is invisible the moment the tab closes. Sound is the shortcut to emotional recall.',
  },
];
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-display font-bold text-4xl md:text-6xl text-center mb-6 leading-tight"
        >
          Your Brand Looks Good.
          <br />
          <span className="text-gray-500">But Nobody Remembers It.</span>
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-gray-400 text-lg text-center max-w-2xl mx-auto mb-20"
        >
          You’ve invested in a logo. A website. Social media. But something is still missing —
          and your customers feel it, even if they can’t name it.
        </motion.p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {problems.map((p, i) => (
            ...
            >
              ...
              />
              <div className="text-4xl mb-6" role="img" aria-label="">
                {p.icon}
              </div>
