  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 40%, rgba(212,175,55,0.08) 0%, rgba(212,175,55,0.03) 40%, transparent 70%)',
        }}
      />

      {/* Halo rings */}
      <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center">
        <div className="halo-ring" style={{ width: 600, height: 600, animationDelay: '0s' }} />
      </div>
      <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center">
        <div className="halo-ring" style={{ width: 400, height: 400, animationDelay: '1.5s' }} />
      </div>
      <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center">
        <div className="halo-ring" style={{ width: 240, height: 240, animationDelay: '0.75s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        >
          ...
          <span className="text-halo-gold text-xs tracking-[0.3em] uppercase font-semibold">
            The Sound Department For Small Businesses
          </span>
          <div className="w-8 h-px bg-halo-gold/60" />
        </motion.div>
        ...
        <motion.h1
          ...
          className="font-display font-bold text-5xl md:text-7xl lg:text-8xl leading-tight mb-8"
        >
          Your Brand{' '}
        ...
        >
          Halo Audio creates custom music, audio branding, and emotional sound experiences that help
          businesses become{' '}
        ...
        >
          <a
            href="#quiz"
            className="btn-gold px-8 py-4 text-base font-bold tracking-wide"
            aria-label="Get your custom brand sound"
          >
        ...
        <motion.div
          ...
          className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-8 text-gray-500 text-sm"
        >
          ...
          <span>Custom audio delivered in 7-14 days</span>
          <div className="hidden sm:block w-px h-4 bg-gray-700" aria-hidden="true" />
          <span>100% original, never stock audio</span>
        </motion.div>
      </div>
