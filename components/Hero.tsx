    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden" aria-label="Hero section">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        <motion.p
          ...
          className="text-gray-400 text-sm tracking-[0.25em] uppercase mb-10"
        >
        ...
        >
          Your Brand <span className="gold-shimmer">Looks Good.</span><br />
          But What Does It <span className="gold-shimmer">Sound Like?</span>
        </motion.h1>
        ...
        >
          Halo Audio creates custom music, audio branding, and emotional sound experiences
          that help businesses become <em className="text-white not-italic font-medium">unforgettable.</em>
        </motion.p>
      ...
      {/* Scroll indicator */}
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.8, duration: 0.8 }} className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2" aria-hidden="true">
