...
const plans = [
  {
    name: 'Halo Starter',
    tagline: 'For businesses ready to be heard.',
    price: '$497',
    period: 'one-time',
    features: [
      'Brand Anthem (60 sec)',
  ...
  {
    name: 'Halo Growth',
    tagline: 'For brands ready to grow through sound.',
    price: '$997',
    period: 'one-time',
    features: [
      'Everything in Starter',
      'Brand Anthem (60 + 30 sec)',
      'Social Sound Pack (10 clips)',
      'Podcast Intro & Outro',
      'Website Atmosphere track',
      '3 revision rounds',
      '10-day delivery',
      'Brand Sound Guide (PDF)',
    ],
    cta: 'Get Halo Growth',
    highlight: true,
    badge: 'Most Popular',
  ...
  {
    name: 'Halo Signature',
    tagline: 'The complete sonic brand experience.',
    price: '$2,497',
    period: 'one-time',
    features: [
      'Everything in Growth',
      'Radio Ad System (30 + 60 sec)',
      'Hold music (2 min loop)',
      'Premium Brand Sound Guide',
      'Unlimited revisions',
      '7-day priority delivery',
      'Quarterly refresh (1 year)',
  ...
  },
  {
    ...
    tagline: 'Ongoing audio for growing businesses.',
    price: '$297',
    period: '/month',
    features: [
      '2 new audio assets/month',
      'Social Sound Refresh (monthly)',
      'Seasonal audio campaigns',
      'Priority support',
      'New service early access',
      'Cumulative brand audio library',
    ],
    cta: 'Join the Club',
    highlight: false,
    badge: 'Subscription',
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          Invest In Sound.
          <br />
          <span className="text-halo-gold">Build A Legacy.</span>
        </motion.h2>
        ...
        >
          Every package includes 100% original audio, full commercial rights, and files ready to
          deploy across every platform your business uses.
        </motion.p>
          ...
          {plans.map((plan, i) => (
            <motion.article
              ...
              className={`relative flex flex-col rounded-2xl border p-8 transition-all duration-500 ${
                plan.highlight
                  ? 'bg-halo-black border-halo-gold/40 shadow-[0_0_60px_rgba(212,175,55,0.12)]'
            ...
            >
              ...
              <ul className="relative space-y-3 mb-8 flex-1" aria-label={`${plan.name} features`}>
              ...
              <a
                href="#quiz"
                className={`relative text-center py-3 px-4 rounded-lg text-sm font-semibold transition-all duration-300 ${
        ...
        >
          All packages include a 100% satisfaction guarantee on the first revision round.
